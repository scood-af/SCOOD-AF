        ...
        <div className="h-full w-full">
            <main className="mx-auto flex h-full w-full flex-col gap-4 px-4 pb-4 md:flex-row md:gap-6 md:px-8 md:pb-6">
                ...
                <Card className="hidden h-full w-full shrink-0 flex-col overflow-hidden rounded-4xl border-4 border-border bg-primary shadow-shadow md:flex md:w-[320px] lg:w-87.5">
                    ...
                    <CardContent className="flex min-h-0 flex-1 flex-col gap-3 p-5 text-left text-foreground">
                        ...
                        <div className="mt-1 w-full shrink-0 text-left">
                            ...
                            <p className="line-clamp-2 text-xs font-medium leading-relaxed text-foreground/80 lg:text-sm">{myHobbies}</p>
                        </div>
                ...
                <div className="flex h-full w-full flex-1 flex-col gap-4 md:gap-6 min-h-0">
                    ...
                    {/* 2. THE SCROLLABLE AREA (Chats + Pool Grid united) */}
                    <div className="flex-1 min-h-0 overflow-y-auto pb-20 pr-2 md:pr-4 flex flex-col gap-6 px-1 pt-1">
                        
                        {/* Chat Section is now inside the scroll wrapper! */}
                        <ChatSection>
                            <ChatList />
                        </ChatSection>
                        ...
                        {poolUsers && poolUsers.length > 0 ? (
                            ...
                            <div className="flex h-64 w-full flex-col items-center justify-center rounded-2xl border-4 border-border bg-background shadow-shadow p-6 text-center">
