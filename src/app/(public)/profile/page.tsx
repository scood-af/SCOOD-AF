...
export default function ProfilePage() {
    ...
    const displayRole = [role.trim(), institution.trim()].filter(Boolean).join(', ') || 'Student'
                ...
                <div className="flex h-full w-full flex-1 flex-col overflow-hidden rounded-4xl border-4 border-border bg-background shadow-shadow">
                    <div className="flex-1 overflow-y-auto p-6 md:p-8">
                        <form id="profile-form" onSubmit={handleSave} className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-3">
                                <label className="text-sm font-extrabold uppercase tracking-wide text-foreground">Profile Picture</label>
                                <div className="flex items-center gap-4">
                                    ...
                                    <input 
                                        ...
                                        className="hidden" 
                                    />
                                    {avatarFile && <span className="text-sm font-bold opacity-70">Image selected</span>}
                                </div>
                            </div>

                            {/* Full Name */}
                            <div className="flex flex-col gap-3">
                                <label className="text-sm font-extrabold uppercase tracking-wide text-foreground">Display Name <span className="text-red-500">*</span></label>
                                <input
                                    type="text"
                                    required
                                    value={fullName}
                            ...
                            {/* Role */}
                            <div className="flex flex-col gap-3">
                                <label className="text-sm font-extrabold uppercase tracking-wide text-foreground">Your Role</label>
                                <input
                                    type="text"
                                    value={role}
                            ...
                            {/* Institution */}
                            <div className="flex flex-col gap-3">
                                <label className="text-sm font-extrabold uppercase tracking-wide text-foreground">Institution</label>
                                <input
                                    type="text"
                                    value={institution}
                            ...
                            {/* Bio */}
                            <div className="flex flex-col gap-3">
                                <label className="text-sm font-extrabold uppercase tracking-wide text-foreground">Bio</label>
                                <textarea
                                    value={bio}
                    ...
                    <div className="shrink-0 border-t-4 border-border bg-background p-6">
                        ...
                        >
                            ...
                            {isSaving ? 'Saving...' : (isOnboarding ? 'Join Pool' : 'Save Changes')}
                        </button>
                    </div>
                </div>
