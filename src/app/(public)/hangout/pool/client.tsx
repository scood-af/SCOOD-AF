...
export default function HangoutPoolClient({
    myProfile,
    myHangout,
    initialPoolUsers,
    currentUserId,
    ...
    return (
        <BasePoolLayout
            ...
            sidebarTags={
                <>
                    {myHangout?.domicile && (
                        <span className="rounded-md border-2 border-border bg-main px-2 py-1 text-[10px] font-extrabold uppercase text-foreground shadow-[2px_2px_0_0_var(--tw-shadow-color)] shadow-border">📍 {myHangout.domicile}</span>
                    )}
                    {myHangout?.topics && (
                        <span className="rounded-md border-2 border-border bg-background px-2 py-1 text-[10px] font-extrabold uppercase text-foreground shadow-[2px_2px_0_0_var(--tw-shadow-color)] shadow-border">💬 {myHangout.topics}</span>
                    )}
                    {myHangout?.offline_open !== undefined && (
                        <span className="rounded-md border-2 border-border bg-main/30 px-2 py-1 text-[10px] font-extrabold uppercase text-foreground shadow-[2px_2px_0_0_var(--tw-shadow-color)] shadow-border">
                            {myHangout.offline_open ? 'Open to Offline Meet' : 'Online Hangout Only'}
                        </span>
                    )}
                </>
            }
            titlePrefix="Chill in the"
            titleHighlight="Hangout Pool!"
